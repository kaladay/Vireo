...
public class FieldProfileTest extends AbstractEntityTest {
    ...
    public void testInheritAndRemoveFieldProfiles() {
        ...
        FieldPredicate fieldPredicate2 = fieldPredicateRepo.create("foo.bar", Boolean.FALSE);
        FieldPredicate fieldPredicate3 = fieldPredicateRepo.create("bar.foo", Boolean.FALSE);
