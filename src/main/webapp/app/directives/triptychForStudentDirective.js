vireo.directive("triptychForStudent", function () {
    return {
        ...
        transclude: true,
        scope: true,
        controller: function ($controller, $q, $scope, $timeout, OrganizationRepo, OrganizationForStudentRepo) {

            angular.extend(this, $controller('AbstractController', {
                $scope: $scope
            }));
console.log("DEBUG: triptychForStudent!");
            $scope.navigation = {
                expanded: true,
                backward: false,
                defer: undefined,
